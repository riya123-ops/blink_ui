...
function FigmaMark() {
  return (
    <svg viewBox="0 0 38 57" aria-hidden="true">
      <path fill="#F24E1E" d="M19 0v19H9.5C4.253 19 0 14.747 0 9.5S4.253 0 9.5 0H19z" />
      ...
      <path fill="#1ABCFE" d="M19 28.5c0-5.247 4.253-9.5 9.5-9.5S38 23.253 38 28.5 33.747 38 28.5 38 19 33.747 19 28.5z" />
